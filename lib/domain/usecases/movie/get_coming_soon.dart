...
class GetComingSoon extends UserCaseBase<List<MovieEntity>,NoParams>{
  final MovieRepository repository;
  GetComingSoon(this.repository);

  Future<Either<AppError,List<MovieEntity>>> call(NoParams noParams) async => await repository.getComingSoon();
}